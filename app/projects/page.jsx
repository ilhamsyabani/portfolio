...
const projectData = [
  ...
  },
  {
    ...
    link: 'https://www.banni.id/sekolah-desain-banni/',
  ...
  },
  {
    ...
    link: 'https://lppm.esaunggul.ac.id/',
  ...
  },
  {
    ...
    link: 'https://validasi.edutechlab.id',
    tech: ['Laravel', 'Filament', 'Tailwind', 'jQuery', 'HTML', 'CSS', 'MySQL', 'Figma'],
